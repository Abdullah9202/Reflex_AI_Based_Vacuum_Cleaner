...
# class ChBar():
#     def __init__(self):
#         # Initializing to make it globally accessible
#         self.frame = None
...
#             self.vacuumObj = vacuum.vCleaner() # Object
#             # Sending the vacuum cleaner towards the charging port
#             if self.vacuumObj.is_OnChPort():
#                 print("Vacuum Cleaner is on charging port.")
